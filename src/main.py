...
pygame.font.init()
GRASS = escalar_imagen(pygame.image.load("resources/grass.jpg"), 2.5)
TRACK = escalar_imagen(pygame.image.load("resources/track.png"), 0.9)
TRACK_BORDER = escalar_imagen(pygame.image.load("resources/track-border.png"), 0.9)
TRACK_BORDER_MASK = pygame.mask.from_surface(TRACK_BORDER)
FINISH = pygame.image.load("resources/finish.png")
FINISH_POSITION = (130, 250)
FINISH_MASK = pygame.mask.from_surface(FINISH)
GREEN_CAR = escalar_imagen(pygame.image.load("resources/green-car.png"), 0.55)
RED_CAR =  escalar_imagen(pygame.image.load("resources/red-car.png"), 0.55)
GREY_CAR = escalar_imagen(pygame.image.load("resources/grey-car.png"), 0.55)
PURPLE_CAR = escalar_imagen(pygame.image.load("resources/purple-car.png"), 0.55)
